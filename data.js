...
const WEAPONS = {
  ...
  ar_t1: {
    ...
    name: 'АКМ', icon: '🎯',
    damage: 1.0, accuracy: 40, magSize: 30,
  ...
  ar_t2: {
    ...
    name: 'Galil', icon: '🎯',
    damage: 1.0, accuracy: 45, magSize: 35,
  ...
  ar_t3: {
    ...
    name: 'FN SCAR-H', icon: '🎯',
    damage: 1.0, accuracy: 52, magSize: 30,
  ...
  ar_t4a: {
    ...
    name: 'G36C', icon: '🎯',
    damage: 1.0, accuracy: 58, magSize: 30,
  ...
  ar_t4b: {
    ...
    name: 'ADAR 2-15', icon: '🎯',
    damage: 1.0, accuracy: 54, magSize: 30,
  ...
  ar_t5a: {
    ...
    name: 'HK416', icon: '🎯',
    damage: 1.0, accuracy: 65, magSize: 30,
  ...
  ar_t5b: {
    ...
    name: 'SIG Spear', icon: '🎯',
    damage: 1.0, accuracy: 60, magSize: 20,
  ...
  ar_t6a: {
    ...
    name: 'HK417', icon: '🎯',
    damage: 1.0, accuracy: 72, magSize: 20,
  ...
  ar_t6b: {
    ...
    name: 'MDRX', icon: '🎯',
    damage: 1.0, accuracy: 66, magSize: 20,
  ...
  smg_t1: {
    ...
    name: 'ПП-19', icon: '⚡',
    damage: 1.0, accuracy: 38, magSize: 53,
  ...
  smg_t2: {
    ...
    name: 'MP5SD', icon: '⚡',
    damage: 1.0, accuracy: 44, magSize: 30,
  ...
  smg_t3: {
    ...
    name: 'P90', icon: '⚡',
    damage: 1.0, accuracy: 50, magSize: 50,
  ...
  smg_t4a: {
    ...
    name: 'SIG MPX', icon: '⚡',
    damage: 1.0, accuracy: 56, magSize: 30,
  ...
  smg_t4b: {
    ...
    name: 'MP7A2', icon: '⚡',
    damage: 1.0, accuracy: 52, magSize: 40,
  ...
  smg_t5a: {
    ...
    name: 'MP9-N', icon: '⚡',
    damage: 1.0, accuracy: 62, magSize: 30,
  ...
  smg_t5b: {
    ...
    damage: 1.0, accuracy: 56, magSize: 33,
  ...
  smg_t6a: {
    ...
    damage: 1.0, accuracy: 70, magSize: 35,
  ...
  smg_t6b: {
    ...
    name: 'SIG "Krait"', icon: '⚡',
    damage: 1.0, accuracy: 62, magSize: 35,
  ...
  sg_t1: {
    ...
    name: 'МП-133', icon: '💥',
    damage: 1.0, accuracy: 35, magSize: 8,
  ...
  sg_t2: {
    ...
    damage: 1.0, accuracy: 40, magSize: 8,
  ...
  sg_t3: {
    ...
    name: 'Saiga-12', icon: '💥',
    damage: 1.0, accuracy: 46, magSize: 10,
  ...
  sg_t4a: {
    ...
    damage: 1.0, accuracy: 50, magSize: 12,
  ...
  sg_t4b: {
    ...
    damage: 1.0, accuracy: 47, magSize: 15,
  ...
  sg_t5a: {
    ...
    name: 'SG Six12', icon: '💥',
    damage: 1.0, accuracy: 54, magSize: 12,
  ...
  sg_t5b: {
    ...
    name: 'Origin-12', icon: '💥',
    damage: 1.0, accuracy: 50, magSize: 16,
    specialBonus: { type: 'damage', value: 2, desc: '+2 к урону за выстрел' },
  ...
  sg_t6b: {
    ...
    damage: 1.0, accuracy: 55, magSize: 10,
  ...
  sr_t2: {
    ...
    name: 'М40', icon: '🔭',
    damage: 1.0, accuracy: 62, magSize: 5,
  ...
  sr_t3: {
    ...
    name: 'L96A1', icon: '🔭',
    damage: 1.0, accuracy: 68, magSize: 10,
  ...
  sr_t4a: {
    ...
    name: 'M200 CT', icon: '🔭',
    damage: 1.0, accuracy: 74, magSize: 7,
    specialBonus: { type: 'accuracy', value: 10, desc: '+10 к меткости за выстрел' },
  ...
  sr_t4b: {
    ...
    name: 'SR-25', icon: '🔭',
    damage: 1.0, accuracy: 68, magSize: 20,
  ...
  sr_t5a: {
    ...
    name: 'AXSR 01', icon: '🔭',
    damage: 1.0, accuracy: 80, magSize: 10,
    specialBonus: { type: 'accuracy', value: 20, desc: '+20 к меткости за выстрел' },
  ...
  sr_t5b: {
    ...
    damage: 1.0, accuracy: 70, magSize: 10,
  ...
  sr_t6a: {
    ...
    name: 'Anzio 20R', icon: '🔭',
    damage: 1.0, accuracy: 88, magSize: 5,
